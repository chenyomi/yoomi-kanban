      ...
      <defs>
        <linearGradient :id="gradientId" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="0%" :stop-color="mergedColor[0]">
            <animate attributeName="stop-color" :values="`${mergedColor[0]};${mergedColor[1]};${mergedColor[0]}`"
              dur="10s" begin="0s" repeatCount="indefinite" />
          </stop>
          <stop offset="100%" :stop-color="mergedColor[1]">
            <animate attributeName="stop-color" :values="`${mergedColor[1]};${mergedColor[0]};${mergedColor[1]}`"
              dur="10s" begin="0s" repeatCount="indefinite" />
          </stop>
        </linearGradient>
        ...
        <mask :id="maskId">
          ...
          <polyline fill="#fff" :points="`8, ${height * 0.15} 8, 3, ${width * 0.1 + 7}, 3
