<template>
  <div class="dv-border-box-11" :ref="ref">
    <svg class="dv-border-svg-container" :width="width" :height="height">
      ...
      <polyline :stroke="mergedColor[0]" :filter="`url(#${filterId})`" :points="`
      ...
      <polygon :stroke="mergedColor[0]" fill="transparent" :points="`
      ...
      <polygon :stroke="mergedColor[0]" :fill="mergedColor[1] || defaultColor[1]" :filter="`url(#${filterId})`" :points="`
      ...
      <polygon :filter="`url(#${filterId})`" :fill="mergedColor[0]" opacity="1" :points="`
      ...
      <polygon :filter="`url(#${filterId})`" :fill="mergedColor[0]" opacity="0.7" :points="`
      ...
      <polygon :filter="`url(#${filterId})`" :fill="mergedColor[0]" opacity="0.5" :points="`
      ...
      <text class="dv-border-box-11-title" :x="`${width / 2}`" y="32" fill="#fff" font-size="18" text-anchor="middle"
        dominant-baseline="middle">
        {{ title }}
      </text>

      <polygon :fill="mergedColor[0]" :filter="`url(#${filterId})`" :points="`
